...
| `Account().Qr`             	   | The method is designed to get QR code for instance authorization                                                              | [QR](https://green-api.com/v3/docs/api/account/qr/)                                                 |
...
| `Account().SendAuthorizationCode`  | This method is designed to complete the instance authorization process. Use the verification code received via SMS when calling the method.  | [SendAuthorizationCode](https://green-api.com/v3/docs/api/account/SendAuthorizationCode/)                     |                                  |
